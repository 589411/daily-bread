...
## 下一個具體動作 ⭐
1. **確認 2026-09-21 的速讀5章**：教會月曆表 9/20 是「拉8-尼2」、9/21 直接跳到「伯30-34」，
   中間漏了 尼3-13、斯1-10、伯1-29（共 50 章＝10 天）。其餘所有月份 s5 都嚴格 +5 連續，**疑似月曆表本身漏排**。
   已「照表原樣」填入；若教會更正，改 `data/schedule.json` 的 2026-09-21 起數天即可。
