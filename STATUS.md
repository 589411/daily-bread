...
## 下一個具體動作 ⭐
1. **向教會反映 2026-09-21 的速讀5章漏排**：官網現行表 9/20「拉8-尼2」→ 9/21「伯30-34」，
   漏 尼3-13、斯1-10、伯1-29 共 50 章（＝10 天）。已查證非舊版、非轉錄錯（見進度脈絡）。
   已「照表原樣」填入；教會若更正，改 `data/schedule.json` 的 2026-09-21 起數天即可。
...
- 2026-08-03 **查證 9/21 速讀5章跳躍**：下載官網 `blccjl.org.tw/bs/`「2026下半年度靈修速讀表」三張圖
  （Last-Modified 皆 2026-06-27、無更正註記）逐格核對——**官網現行版就是這樣，不是舊版**。
  9/20 拉8-尼2 → 9/21 伯30-34，漏 尼3-13／斯1-10／伯1-29 共 50 章；總量驗算（925+50≈974 章）證實是製表漏 10 列。已照表原樣保留，待向教會反映。
